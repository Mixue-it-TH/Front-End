...
export async function handleVisibleMode(visibility, paramId) {
  ...
  try {
    const response = await fetch(`${import.meta.env.VITE_BASE_URL}/${paramId}`, {
      method: "PATCH",
      headers: {
...
export async function getCollaborators(boardId) {
  ...
  try {
    const response = await fetch(`${import.meta.env.VITE_BASE_URL}/${boardId}/collabs`, {
      method: "Get",
      headers: {
        Authorization: `Bearer ${token}`,
        "Content-Type": "application/json",
...
export async function getCollaboratorsByCollabId(boardId, collabId) {
  ...
  try {
    const response = await fetch(`${import.meta.env.VITE_BASE_URL}/${boardId}/collabs/${collabId}`, {
      method: "Get",
      headers: {
        Authorization: `Bearer ${token}`,
        "Content-Type": "application/json",
