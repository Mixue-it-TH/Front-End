...
<template>
  <div class="backdrop-blur-sm bg-black/50 w-screen h-screen fixed top-0 left-0 z-[30] font-nonto">
    <div class="flex justify-center items-center w-[100%] h-[100%]">
      <div
        class="fade-up itbkk-modal-setting flex flex-col w-[75%] min-w-[300px] h-[50%] max-w-[600px] min-h-[400px] rounded-[8px] mobile-L:mb-[70px] mobile-L:h-[490px] bg bg-primary text-secondary ">
        <div class="">
          <p class="text-3xl pl-4 pt-5">Status Setting
          </p>
          <div class="border-b-2 border-gray-300 mt-5"></div>
        </div>
        <div class="w-full">
          <div>
            <p class="px-5 pt-5  text-[16px]"> User can limit the number of task in a
              status by setting
              the
          ...
          <div class="">
            <div class="mt-5 px-5">
              <label class=" inline-flex items-center cursor-pointer">
                ...
                <span class="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">
                  <p class=" text-lg"> Limit task in this status </p>
            ...
            <div class="flex mobile-L:flex-col pt-5 ">
              <p class="pl-5 pt-2  text-lg font-semibold">Maximum tasks</p>
              <div>
                <input class="itbkk-max-task mb-5 ml-5 p-2.5 w-50px text-sm text-gray-900 rounded-lg border border-gray-200
                 focus:ring-blue-500 focus:border-blue-500 bg-accent dark:border-gray-400 dark:placeholder-gray-black
