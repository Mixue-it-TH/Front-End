      ...
      <div class="itbkk-modal-setting flex flex-col w-[75%] h-[60%] rounded-[15px] bg bg-white" > 
        ...
        <div class="w-full"> 
          ...
          <div class="mt-10"> 
            ...
            <input type="checkbox" value="" class="itbkk-limit-task sr-only peer" 
             v-model="isEnable" /> 
              ...
              <div> 
                <input class="itbkk-max-task mb-5 ml-5 p-2.5 w-50px text-sm text-gray-900 rounded-lg border border-gray-200
                 focus:ring-blue-500 focus:border-blue-500 bg-white dark:border-gray-400 dark:placeholder-gray-black
                  dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" type="number" v-model="amountMaximum" ></input> 
                </div> 
              </div> 
                ...
                <div class="flex flex-row-reverse"> 
                  <div class=""> 
                    ...
                    <div class=""> 
                      ...
                      text-white bg bg-green-500 hover:bg-green-400 rounded-lg mr-5" @click="[$emit('save', isEnable, amountMaximum)]" > save </button> 
                    </div> 
                    </div> 
                    </div> 
                    </div> 
