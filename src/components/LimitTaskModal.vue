   ...
   <div class="backdrop-blur-sm bg-black/50 w-screen h-screen fixed top-0 left-0 z-[30] font-nonto" > 
    <div class="fade-up flex justify-center items-center w-[100%] h-[100%]"> 
      <div class="itbkk-modal-setting flex flex-col w-[75%] h-[60%] rounded-[15px] bg bg-white" > 
        ...
        <div class="w-full"> 
          <div> 
          <p class="px-4 pt-5 ml-5 text-black text-xl"> User can limit the number of task in a status by setting the Maximum tasks in each status<br>(except"No Status"and"Done"statuses) </p> 
        </div> 
          <div class="mt-10"> 
            ...
            <span class="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300" >
              ...
              <div> 
                <input class=" mb-5 ml-5 p-2.5 w-50px text-sm text-gray-900 rounded-lg border border-gray-200
                 focus:ring-blue-500 focus:border-blue-500 bg-white dark:border-gray-400 dark:placeholder-gray-black
                  dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" type="number" v-model="limitMaximux" ></input> 
                </div> 
              </div> 
                ...
                <div class="flex flex-row-reverse"> 
                  <div class=""> 
                    ...
                    border-gray-400 border w-[80px] h-[40px] font-[600] text-gary-800
                     ...
                     mr-5" @click="$emit('cancel', false)" > cancle </button> </div> 
                    <div class=""> 
                      <button class="itbkk-button itbkk-button-confirm border-gray-400 border disabled w-[65px] h-[40px] font-[600] 
                      text-white bg bg-green-500 hover:bg-green-400 rounded-lg mr-5" @click="[handelLimit(isLimit,limitMaximux),$emit('cancel', false)]" > save </button> 
                    </div> 
                    </div> 
                    </div> 
                    </div> 
