...
<template>
  <div class="h-[500px]">
    ...
    <Listmodel
      :jobs="taskManagement.getAllTask()"
      v-if="taskManagement.getAllTask().length != 0"
    >
      <template #default="slotprop">
        ...
        >
          <router-link
            :to="{ name: 'taskDetail', params: { id: slotprop.job.id } }"
            class="w-full h-full"
          >
            <div class="flex w-full min-h-[55px]">
              ...
              <div class="w-[10%]">
                <div
                  class="w-[100px] rounded-[5px] flex items-center justify-center"
                  :style="{
          ...
          <div class="itbkk-button-action dropdown dropdown-end dropdown-hover">
            ...
            >
              <router-link
                :to="{ name: 'taskEdit', params: { id: slotprop.job.id } }"
              >
