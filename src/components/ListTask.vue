    ...
    slotprop.job.assignees
      ...
      : "Unassigned"
          ...
          <div class="itbkk-button-action dropdown dropdown-end dropdown-hover z-[1]">
            <div tabindex="0" role="button" class="btn m-1 z-[1] bg bg-gray-[#A9A9A9]">
            ...
            <ul tabindex="0"
              ...
              <router-link :to="{ name: 'taskEdit', params: { id: slotprop.job.id } }">
                <li class="itbkk-button-edit flex flex-row">
                  <a class="px-5">Edit <img class="px-0" src="/image/edit-icon.png" width="25px" /></a>

                </li>
              </router-link>
              <div>
                <li class="itbkk-button-delete flex flex-row w-full"
                  @click="emit('delete', slotprop.job, slotprop.key + 1)">
                  <a class="px-5 text-red-500">Delete<img class="px-0" src="/image/delete-image.png" width="25px" /></a>
