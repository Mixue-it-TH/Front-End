    ...
    <div class="hero bg-gray-200 max-h-screen z-50 absolute inset-0">
      <div class="hero-content flex-col lg:flex-row-reverse mb-[500px]">
        <div class="text-center lg:text-left">
          <img class="ml-[10px] tablet:w-[15%] laptop:w-[100px] mobile:w-[5%]" src="/image/SIT-logo.png" />
          ...
          <form class="card-body">
            <div class="form-control">
              ...
              <input v-model="userName" type="text" placeholder="username"
                class="itbkk-username input input-bordered bg-gray-200" @click="isValid = false"
                :class="isValid === true ? 'border border-red-600' : ''" maxlength="50" required />
            </div>
            ...
            <div class="form-control">
              ...
              <input v-model="password" type="password" placeholder="password"
                class="itbkk-password input input-bordered bg-gray-200" :class="isValid === true && password === ''
            ...
            <div class="form-control mt-6 itbkk-button-signin">
              <button class="btn btn-primary text-xl" @click="register" :disabled="userName === '' || password === ''">
                Login
              </button>
            </div>
          </form>
      ...
      <footer class="footer flex justify-center bg-gray-200 text-neutral-content mt-[100px] w-screen">
