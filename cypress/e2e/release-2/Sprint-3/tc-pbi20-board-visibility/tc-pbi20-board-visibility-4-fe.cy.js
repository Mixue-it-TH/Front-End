// ไม่สามารถ TEST ผ่านได้เพราะมี test คาดหวังให้เรา redirect ไปยัง board ที่สร้างขึ้นโดยทันที
...
describe(`TC-PBI20-BOARD-VISIBILITY-1-FE\n 
  ...
  it('[Step 2] Should show modal "Do you want to change board visibility to public?".', () => {
    ...
    cy.get("@modal")
      .find(".itbkk-message")
      .contains("Do you want to change board visibility to public?");
  });
  ...
  it(`[Step 4 and 5] Should click "Confirm" button. The mocAPI return 403 
    ...
    cy.get("@modal")
      .find(".itbkk-message")
      .contains("Do you want to change board visibility to private?");
    cy.get("@modal").find(".itbkk-button-confirm").click();
